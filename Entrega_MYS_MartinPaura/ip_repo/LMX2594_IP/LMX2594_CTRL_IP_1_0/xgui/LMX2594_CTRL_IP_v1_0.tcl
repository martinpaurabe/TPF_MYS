...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "prescaleFactor"
  ipgui::add_param $IPINST -name "N_signal"
...
proc update_PARAM_VALUE.N_signal { PARAM_VALUE.N_signal } {
	# Procedure called to update N_signal when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.N_signal { PARAM_VALUE.N_signal } {
	# Procedure called to validate N_signal
	return true
}
...
proc update_MODELPARAM_VALUE.N_signal { MODELPARAM_VALUE.N_signal PARAM_VALUE.N_signal } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.N_signal}] ${MODELPARAM_VALUE.N_signal}
}
